...
public class FriendAdapter extends RecyclerView.Adapter<FriendAdapter.FriendViewHolder> {
    ...
    public void onBindViewHolder(@NonNull FriendAdapter.FriendViewHolder holder, int position) {
        ...
        holder.cvNote.setOnClickListener(new unikom.tugasutsakb.fauzisunarya_10117110.presenter.CustomOnItemClickListener(position, new unikom.tugasutsakb.fauzisunarya_10117110.presenter.CustomOnItemClickListener.OnItemClickCallback() {
            @Override
